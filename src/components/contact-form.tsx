    ...
    return (
        <div>
            <form className="contact-form" onSubmit={handleSubmit} aria-describedby="form-note">
                ...
                <div className="field">
                    <label htmlFor="organization">Business or organization name</label>
                ...
                <div className="field">
                    ...
                    <textarea id="details" name="details" rows={7} required />
                </div>
            ...
            {submission ? (
                ...
                >
                    <h3 id="submission-title">Thanks, {submission.name}!</h3>
                    <p>Your event request was submitted successfully.</p>
                    <dl>
                        <div>
                            <dt>Email</dt>
