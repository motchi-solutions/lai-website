...
export default function Home() {
    return (
        <>
                ...
                <section className="section hero" id="mission" aria-labelledby="mission-title">
                    <div className="section-inner hero-grid">
                        <div className="hero-copy">
                            ...
                            <h1 className="display-title" id="mission-title">
                                A drink menu
                                <br />
                                catered to you.
                            </h1>
                            <p className="lede">
                                Elevate your event with a premium tea and coffee menu tailored to
                ...
                <section className="section events" id="events" aria-labelledby="events-title">
                    <div className="section-inner events-grid">
                        <div className="events-copy">
                            <h2 className="display-title" id="events-title">
                                Take drink
                                <br />
                                planning off
                                <br />
                            ...
                            <p className="lede">
                                From corporate to community events, our custom menus make
                                refreshment simple and delicious.
                            </p>
                        </div>
                        <div
                ...
                <section className="section method" id="method" aria-labelledby="method-title">
                    <div className="section-inner method-grid">
                        ...
                        <div className="method-copy">
                            ...
                            <p className="lede">
                                Every drink on your menu is handcrafted with carefully chosen
                                ingredients. It&apos;s all made fresh for your guests to enjoy.
                            </p>
                        </div>
                    </div>
                </section>
            ...
            <footer>
                <p>© {new Date().getFullYear()} Lai Catering. Serving the Greater Toronto Area.</p>
            </footer>
        </>
    );
}
